                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="discount-coupon">
                                    ...
                                    <div class="coupon-form">
                                        <input type="text" value="{{ $kode ?? '' }}" id="code" name="code" max='10' placeholder="Enter your codes">
                                        <button type="button" class="site-btn coupon-btn" id="kupon-cek">Apply</button>
                                    </div>
                                    <span class="text-danger" id="alert_code"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 offset-lg-4">
                                <div class="proceed-checkout">
                                    ...
                                    <span class="proceed-btn" id="submit_ok">PROCEED TO CHECK OUT</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $('#kupon-cek').click(function(){
            ...
            if(code == ''){
                ...
                //     icon: 'warning',
                // });
                $("#alert_code").text('Kode tidak boleh kosong');
            }else{
                $.ajax({
                    type: "get",
                    url: "kupon",
